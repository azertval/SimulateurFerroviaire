...
- Progress Bar : barre de progression pour les tâches longues
...
- GeoParserEnums : énumérations utilisées dans le module GeoParser (par exemple, pour les types de nœuds, les types d’arêtes, etc.)
- GeoParserExceptions : gestion des exceptions spécifiques au module GeoParser (par exemple, pour les erreurs de parsing, les erreurs de construction du graphe, etc.)
- GeoParserUtils : fonctions utilitaires pour le module GeoParser (par exemple, pour la validation des données, la conversion de coordonnées, etc.)
