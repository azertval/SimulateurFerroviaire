...
public:
     ...
     * @return Instruction JavaScript : Retourne une chaîne vide si le switch n'est pas orienté...
     */
    static std::wstring renderSwitchBranches(const SwitchBlock& sw);

    /**
     * @brief Génère le script JS complet de rendu de toute la topologie.
     *
     ...
     *
     * Remplace les trois anciens renderAll*() par un point d'entrée unique
     * destiné à MainWindow::onParsingSuccess().
     *
     * @return Script JS complet — un seul executeScript() suffit.
     */
